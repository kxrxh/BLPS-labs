# BLPS Labs Database Seeding Guide

This guide will help you populate your database with test data using your API endpoints.

## Setup Instructions

1. Import the `BLPS_Labs_Postman_Collection.json` and `BLPS_Labs_Postman_Environment.json` files into Postman
2. Select the `BLPS Labs Environment` environment from the dropdown in the top-right corner
